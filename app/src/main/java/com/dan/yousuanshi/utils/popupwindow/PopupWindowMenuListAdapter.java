...
public class PopupWindowMenuListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
	...
	public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		View view = LayoutInflater.from(myContext).inflate(R.layout.item_chat_menu, parent, false);
	...
	static class ItemViewHolder extends RecyclerView.ViewHolder
	{
		...
		{
			super(view);
			itemText = (TextView) view.findViewById(R.id.tv_menu_name);
			itemImg = (ImageView) view.findViewById(R.id.iv_menu_icon);
